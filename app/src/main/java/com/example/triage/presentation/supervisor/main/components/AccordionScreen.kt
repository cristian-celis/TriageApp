package com.example.triage.presentation.supervisor.main.components
...
import com.example.triage.domain.models.dto.PatientDtoForList
...
private fun AccordionRow(patient: PatientDtoForList, level: Int) {
    Row(
        ...
        Text(
            text = "${patient.idType}. ${patient.idNumber}",
